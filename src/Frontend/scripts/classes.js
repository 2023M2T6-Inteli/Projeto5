  ...
  function createDivs(classes) {
    ...
    classes.forEach(async (classData) => {
      ...
      try {
        ...
        // Aqui você pode criar as divs internas com base nas médias das notas
        // e definir o tamanho delas com base na porcentagem do pai
        // Exemplo:
        ...
        competencyNames.forEach((competency, index) => {
          ...
          const percentage = averages[`average_grade${index + 1}`] || 0; // Se a média for nula, considera 0
